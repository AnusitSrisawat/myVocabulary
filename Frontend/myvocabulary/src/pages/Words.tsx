...
export default function Words() {
  ...
  return (
    <>
      <div className="relative flex w-screen max-w-screen min-h-screen h-fit flex-col md:flex-row items-center md:items-start justify-center gap-10 md:gap-20 p-10 overflow-y-auto overflow-x-hidden">
        <div className='relative bg-slate-700 shadow-xl bg-opacity-40 rounded-3xl flex flex-col justify-center items-center'>
        ...
        <div className='relative bg-slate-700 shadow-xl bg-opacity-40 rounded-3xl flex flex-col justify-start items-start p-5 w-full md:w-auto gap-2 overflow-auto'>
